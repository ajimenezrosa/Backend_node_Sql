...
exports.getConections = getConections;
...
function getConections() {
  return _getConections.apply(this, arguments);
}

function _getConections() {
  _getConections = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
    var pool;
